...
<style>
    .customizer[_ngcontent-rta-c5] {
        ...
        bottom: 0;
        height: 100vh;
        -webkit-transition: right.4scubic-bezier(.05, .74, .2, .99);
        transition: right.4scubic-bezier(.05, .74, .2, .99);
        -webkit-backface-visibility: hidden;
        backface-visibility: hidden;
        border-left: 1pxsolidrgba(0, 0, 0, .05);
        box-shadow: 008pxrgba(0, 0, 0, .1)
    }
    ...
    .customizer[_ngcontent-rta-c5]a.customizer-toggle[_ngcontent-rta-c5] {
        ...
        display: block;
        box-shadow: -3px08pxrgba(0, 0, 0, .1)
    }
    ...
    [dir=rtl][_nghost-rta-c5].customizer {
        left: -400px;
        right: auto;
        border-right: 1pxsolidrgba(0, 0, 0, .05);
        border-left: 0
    }
